...
ALLOWED_HOSTS = [
    ...
    os.environ.get('HOSTNAME', 'ddeveloper72-django-blog.herokuapp.com'),
]
...
INSTALLED_APPS = [
    ...
    'django_forms_bootstrap', # add in our apps
    'posts', # add in our apps
]
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'templates')], # include our templates folder to base dir
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
                ...
                'django.template.context_processors.media', # add comma at the end
            ],
        },
    },
]
...
MEDIA_URL = '/media/'
MEDIA_ROOT = os.path.join(BASE_DIR, 'media') # add the media directory to the base dir